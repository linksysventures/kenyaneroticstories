...
<body bgcolor="#333333" vlink="#6666CC" alink="#0000FF" onload="MM_preloadImages('Contact us/Images/x.png')">
...
<p align="justify"><em>We all have those deep, dark erotic stories we die to tell someone but we have no one to tell. Now you have a chance to tell your story, and better yet, <strong><a href="Paymernt to content suppliers.html">get paid </a></strong>for it. Yea!,, we pay for your story. What you have to do is, write it down on a text editor of your choice, fill the form bellow and copy-paste it. Remember to quot your name for credits.</em></p>
<p align="justify"><em><strong>Alternatively</strong> you can upload it in form of a <strong>text</strong> <strong>document</strong> or a <strong>.pdf</strong> document by clicking <a href="upload.php">here</a> or on the link provided bellow. Take note that we pay you as <a href="Paymernt to content suppliers.html">indicated here</a> after your story has been published.</em></p>
<p align="justify"><a href="upload.php">Click Here to Upload your Story</a></p>
<p align="justify">or</p>
<p align="justify"><strong>Fill the Form Bellow.</strong></p>
...
" /><?php if(in_array('email', $validation)): ?><span class="error"><?php echo $error_messages['email']; ?></span><?php endif; ?>
	...
	<div class="row">
    <div class="label">Paste your Story Here</div>	<!-- end .label -->
    <div class="imput2">
    ...
    <?php else: ?>
<p align="center">Thank you for your imput! We will get back to you via email after we have reviewed your story.</p>
...
<p align="center"><a href="Home.html"><strong>Click here to see more stories</strong></a></p>
<p align="center">&nbsp;</p>
<p align="center">&nbsp;</p>
<?php endif; ?>
