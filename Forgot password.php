...
if(!empty($_POST)) {
	...
	foreach($required_fields as $field) {		
		...
		if($_POST[$field] == 'email') array_push($validation, $field);
...
<!-- Covered under creative commons license - http://dreamweavertutorial.co.uk/permissions/contact-form-permissions.htm -->
	...
	<title>Kenya Erotic Stories | Forgot Password</title>
...
<div class="header"><div id="apDiv4">
  ...
  <div class="sidebar1">
    <ul class="nav">
      <li><a href="All Stories.html" class="nav">Stories</a>
      <li><a href="send your stories.php">Submit  Stories</a></li>
      <li><a href="Submit Expose.php">Send Expose</a>
...
<h2>Forgot your KES Password</h2>
<p align="justify">Please enter your email address and hit submit and we will email your password to you.</p>
<form action="Forgot password.php" method="post" id="comments_form"><!-- end .row -->
...
" /><?php if(in_array('email', $validation)): ?><span class="error"><?php echo $error_messages['email']; ?></span><?php endif; ?>
    ...
    <div class="context">e.g.example@somedomain.com, we wont share your email with anyone</div><!-- end .context -->    </div><!-- end .row --><!-- end .row -->
    ...
    <?php else: ?>
<p align="center">Your password will be sent to the Email Address you provided.</p>
<p align="center">Thank you for staying erotic. </p>
...
<p align="center"><a href="Login.php"><strong>Click here to Login</strong></a></p>
<p align="center">&nbsp;</p>
<p align="center">&nbsp;</p>
<?php endif; ?>
