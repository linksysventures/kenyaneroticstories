...
<!-- Covered under creative commons license - http://dreamweavertutorial.co.uk/permissions/contact-form-permissions.htm -->
	...
	<title>Kenya Erotic Stories | Support</title>
...
<p>Please feel free to fill this form with your questions and we shall get back to you as soon as possible.</p>
...
" /><?php if(in_array('email', $validation)): ?><span class="error"><?php echo $error_messages['email']; ?></span><?php endif; ?>
	...
	<div class="row">
    <div class="label">Ask your question</div>	<!-- end .label -->
    <div class="imput2">
    ...
    <?php else: ?>
<p align="center">Thank you for your Querry. You will be answered as soon as possible.</p>
