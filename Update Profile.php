...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE users SET FirstName=%s, LastName=%s, UserName=%s, Email=%s, Password=%s WHERE UserID=%s",
...
<title>Kenyan Erotic Stories | Update Profile</title>
<style type="text/css">
<!--
body {
...
<div class="container">
  <div class="header"><!-- end .header --><a href="Home.html"><img src="Backup_of_banner.JPG" width="959" height="152" /></a></div>
  <div class="sidebar1">
    <ul class="nav">
    ...
    <table width="550" border="0">
      <tr>
        <td><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
          <table width="550" border="0">
            <tr>
              <td><label for="FirstName"><span id="sprytextfield1">
                First Name*<br />
                <input name="FirstName" type="text" id="FirstName3" value="<?php echo $row_User['FirstName']; ?>" size="50" />
            ...
            <tr>
              <td><span id="sprytextfield2">
                ...
                Last Name *<br />
                <input name="LastName" type="text" id="LastName" value="<?php echo $row_User['LastName']; ?>" size="50" />
            ...
            <tr>
              <td><span id="sprytextfield3">
                ...
                User Name*<br />
                <input name="UserName" type="text" id="UserName" value="<?php echo $row_User['UserName']; ?>" size="50" />
                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
...
Email*<br />
<input name="Email" type="text" id="Email" value="<?php echo $row_User['Email']; ?>" size="50" />
<span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
            ...
            <tr>
              <td><span id="sprytextfield5">
                ...
                Password*<br />
                <input name="Password" type="password" id="Password" value="<?php echo $row_User['Password']; ?>" size="50" />
                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><input type="submit" name="SubmitUserForm" id="SubmitUserForm" value="Update Profile" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
