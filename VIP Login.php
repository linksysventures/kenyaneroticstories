...
<title>Kenyan Erotic Stories | Login</title>
<style type="text/css">
<!--
body {
...
<div class="container">
  <div class="header"><div id="apDiv7"><img src="used photos/New Picture (2).bmp" width="188" height="42" /></div><div id="apDiv6"><img src="used photos/New Picture (1).bmp" width="186" height="44" /></div><div id="apDiv4"><img src="used photos/New Picture.bmp" width="182" height="44" /></div><!-- end .header --><a href="Home.html"><img src="Backup_of_banner.JPG" width="959" height="152" /></a></div>
  <div class="sidebar1">
    <ul class="nav">
  ...
  <div class="content">
    ...
    <h1>&nbsp;</h1>
    <h3>Log in to Kenyan Erotic Stories as a VIP.</h3>
    <p>Send 100/= to this number to be registered as a VIP member and enjoy the videos and more gold services.</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>If you don't have an account, please click on <a href="User Registration.php">register</a> to register for an account with us.</p>
    <table width="550" border="0">
      <tr>
        <td><form id="LoginForm" name="LoginForm" method="POST" action="<?php echo $loginFormAction; ?>">
          <table width="550" border="0">
            <tr>
...
Password: <br />
            ...
            <tr>
              <td>Dont have an account? <a href="User Registration.php">Register</a> | <a href="Forgot password.php">Forgot Password</a></td>
            </tr>
          </table>
        </form></td>
      </tr>
