    ...
    <table width="550" border="0">
      <tr>
        <td><form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
          <p align="left">Control Panel</p>
          <p align="left"><a href="Update Profile.php?<?php echo $row_Recordset1['UserName']; ?>=">Update Profile</a> | <a href="Admin.php">Admin</a> | <a href="Logout.php">Log Out</a></p>
        </form></td>
      </tr>
    </table>
    <p align="center">&nbsp;</p>
    <p align="center">Now that you are logged in, you can access all the Restricted pages, thank you for staying erotic.</p>
    <p align="center">or</p>
    <p align="center"><a href="Home.html">Go back to the home page. </a></p>
  </div>
  <div class="sidebar2">
