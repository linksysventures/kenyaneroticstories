...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO users (FirstName, LastName, UserName, Email, Password) VALUES (%s, %s, %s, %s, %s)",
...
<title>Kenyan Erotic Stories | Register</title>
<style type="text/css">
<!--
body {
...
<div class="container">
  ...
  <div class="content">
    ...
    <h1>&nbsp;</h1>
    <h3>Joining Kenyan Erotic Sories..</h3>
    <p>Ready to join KenyanErotic stories? Membership is free and fun. Nothing shows, not even your username shows on the site.</p>
